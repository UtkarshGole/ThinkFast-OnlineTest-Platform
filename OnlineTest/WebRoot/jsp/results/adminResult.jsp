...
<%
    ...
    ArrayList<ResultsDto> list = ResultsDao.getAllExamsResult();
...
.result-card span{
	display: block;  /* 👈 This ensures they stack vertically */
}

.result-card span,
.result-card strong {
	margin-bottom: 0.8rem; /* vertical space between lines */
}
   ...
   <!-- *HERO SECTION OR CENTER SECTION =================================================-->
	...
	<div class="hero-section">
		<div class="hero-text" data-aos="fade-right" data-aos-once="false">
			...
			<h1>
				Review Students <br /> <span>Performance</span>
			</h1>
